...
export const HABIT_Biblio: Partial<Habit>[] = [
    ...
    { name: "👀 Lateral Eye Movements", vector: "Cognitive", primary_driver: "GABA", secondary_driver: "Acetylcholine", state: -3, friction: 2, duration: 5, time_of_day: "evening" },
    ...
    { name: "🕉️ Humming / Chanting", vector: "Cognitive", primary_driver: "GABA", secondary_driver: "Oxytocin", state: 4, friction: 2, duration: 5, time_of_day: "evening" },
